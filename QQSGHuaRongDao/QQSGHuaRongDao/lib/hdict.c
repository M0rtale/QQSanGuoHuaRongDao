...
hdict* hdict_new(size_t capacity,
                 ...
                 entry_free_fn *entry_free) {
  assert(capacity > 0);
  assert(entry_key != NULL && key_equal != NULL && key_hash != NULL);
